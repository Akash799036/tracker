...
export default function Sidebar({ open, onClose }: { open: boolean; onClose: () => void }) {
  ...
  return (
    <>
      <aside className={`fixed z-40 lg:sticky lg:top-0 lg:h-screen inset-y-0 left-0 w-64 bg-white border-r border-slate-200 flex flex-col transition-transform ${open ? '' : '-translate-x-full lg:translate-x-0'}`}>
