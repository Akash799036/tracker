...
const sidebarRef = useGsap('slide');
  return (
    <>
      <aside ref={sidebarRef} className={`fixed z-40 lg:sticky lg:top-0 lg:h-screen inset-y-0 left-0 w-64 max-w-[85vw] bg-white/55 backdrop-blur-xl backdrop-saturate-150 border-r border-white/50 flex flex-col transition-transform ${open ? '' : '-translate-x-full lg:translate-x-0'}`}>
